var app = angular.module("app", ["pascalprecht.translate", "monospaced.qrcode"]).config(function($translateProvider) {
	...
	$translateProvider.translations("nl_NL", {
		...
		about_description: "Bartiméus is een stichting met veel kennis en ervaring in het ondersteunen van mensen met een visuele en/of bijkomende beperking. Als zij de kennis (nog) niet hebben, ontwikkelen zij die in de vorm van nieuwe methodieken en trainingen. Zo dragen zijn bij aan een beter leven voor mensen met een visuele en/of bijkomende beperking. Zij zien het ook als hun opdracht om de maatschappij alerter en toegankelijker te maken zodat mensen met een visuele beperking zo volwaardig mogelijk kunnen deelnemen. Ze stellen daarom hun kennis en ervaring beschikbaar en nemen actief deel aan het maatschappelijk debat.",
		project_description_title: "Over de HvA Studenten",
		project_description: "Wij, de ontwikkelaars van dit project, zijn vijf studenten ICT aan de Hogeschool van Amsterdam.<br/><br/>We zijn een internationaal en multidisciplinair team bestaande uit 1 Business IT & Management student (Mick Nieman NL), 2 studenten Software Engineering (Robin de Jong NL en Ben Tasma NL) en twee Computer Science (Jim Joyce UK en Victor Segura ES) studenten. In het derde jaar van onze opleidingen. Voor het project Internet of Things hebben wij in opdracht voor Bartiméus een product ontwikkeld dat doof blinden zal helpen bij het alledaagse leven. Voor verdere info over het product verwijzen wij door naar <a href='https://www.theassistant.io'>www.theassistant.io</a>.<br/><br/>Met vriendelijke groet,<br/>Team The Assistant.",
